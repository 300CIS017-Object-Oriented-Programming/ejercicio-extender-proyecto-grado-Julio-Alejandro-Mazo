...
class MainView:
    ...
    def _dibujar_layout(self):
        ...
        with st.sidebar:
            ...
            self.menu_actual = option_menu("Menu", ["Inicio", 'Crear acta', 'Evaluar acta', 'Ver históricos', 'Exportar Acta'],
                                           icons=['house', 'mortarboard', 'people', 'person-check-fill', 'book' ], menu_icon="cast", default_index=0)
